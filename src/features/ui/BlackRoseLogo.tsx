...
export const BlackRoseLogo: React.FC<BlackRoseLogoProps> = ({ className }) => {
	return (
		<div
			className={`relative flex items-center justify-center glow-box rounded-full bg-black/50 ${className || "w-48 h-48"}`}
		>
			<svg
				aria-hidden="true"
				focusable="false"
			...
			>
				...
				<g className="animate-pulse">
					...
					/>
					<path
						d="M50 50 C 40 50 40 40 50 40 C 60 40 60 50 50 50 Z"
						fill="#1a0520"
					/>
			...
			{/* Glow Overlay */}
			<div className="absolute inset-0 rounded-full bg-[radial-gradient(circle,rgba(74,14,92,0.2)_0%,transparent_70%)] pointer-events-none" />
		</div>
	);
};